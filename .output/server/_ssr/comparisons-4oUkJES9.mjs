...
//#region node_modules/.nitro/vite/services/ssr/assets/comparisons-4oUkJES9.js
...
var COMPARISONS = [
	{
		...
		pricingNote: "Competitor pricing is based on publicly available information and is reviewed regularly for accuracy. Prices may change over time, so always confirm the latest pricing on the provider's official website.",
		usPros: commonUsPros,
		usCons: commonUsCons,
		themPros: [
	...
	},
	{
		...
		pricingNote: "Hootsuite pricing is based on publicly available information at the time of review. For the latest plans and pricing, please visit Hootsuite's official pricing page.",
		usPros: commonUsPros,
		usCons: commonUsCons,
		themPros: [
