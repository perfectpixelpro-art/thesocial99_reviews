import { n as getComparison, r as SiteShell, t as COMPARISONS } from "./comparisons-4oUkJES9.js";
import { a as ProsConsBox, h as keywordsForCompetitor, i as TableOfContents, m as buildHead, n as mergedFaqsForCompetitor, o as AuthorByline, p as absoluteUrl, s as breadcrumbJsonLd, t as faqPageJsonLd } from "./faqSchema-C_Qcepuv.js";
...
import { Link, createFileRoute, lazyRouteComponent, notFound } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Check, Minus } from "lucide-react";
//#region src/components/comparison-table.tsx
function cellRender(value) {
	if (value.toLowerCase().startsWith("yes")) return /* @__PURE__ */ jsxs("span", {
	...
	if (value.toLowerCase() === "n/a" || value.toLowerCase().startsWith("no ")) return /* @__PURE__ */ jsxs("span", {
...
//#endregion
//#region src/components/comparison-article.tsx
var TOC = [
	{
		id: "quick-verdict",
		label: "Quick verdict"
				...
				children: [
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [
							...
							data.overview.slice(1).map((p, i) => /* @__PURE__ */ jsx("p", { children: p }, i))
						]
					}),
					/* @__PURE__ */ jsxs("section", {
						id: "feature-comparison",
						children: [
							...
							/* @__PURE__ */ jsx("p", { children: "Side-by-side, the biggest gap isn't feature parity - it's who actually does the work each week." }),
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("p", { children: "Direct answer: The Social 99 offers simple monthly pricing with no setup fees or long-term contracts. Pricing shown below reflects our current plans." }),
							/* @__PURE__ */ jsx("div", {
								className: "overflow-hidden rounded-2xl border border-border shadow-[var(--shadow-card)]",
								children: /* @__PURE__ */ jsx("div", {
									className: "overflow-x-auto",
									children: /* @__PURE__ */ jsxs("table", {
										...
										}) }), /* @__PURE__ */ jsx("tbody", { children: data.pricingRows.map((r, i) => /* @__PURE__ */ jsxs("tr", {
					...
					/* @__PURE__ */ jsxs("section", {
						id: "pros-cons",
						children: [/* @__PURE__ */ jsx("h2", { children: "Pros & cons - honest, both sides" }), /* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("section", {
						id: "bottom-line",
						children: [/* @__PURE__ */ jsx("h2", { children: "Bottom line: who should pick what" }), /* @__PURE__ */ jsxs("div", {
							className: "grid gap-4 md:grid-cols-2",
					...
					/* @__PURE__ */ jsxs("section", {
						id: "related",
						className: "not-prose",
						children: [/* @__PURE__ */ jsx("h2", { children: "Related comparisons" }), /* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", {
						className: "not-prose",
						children: /* @__PURE__ */ jsx(CTABanner, { pageSlug: data.slug })
					})
				]
...
var $$splitNotFoundComponentImporter = () => import("./blog._slug-CIMLPq7I.js");
var $$splitComponentImporter = () => import("./blog._slug-DYQpXoo8.js");
...
//#endregion
export { ComparisonArticle as n, Route as t };
