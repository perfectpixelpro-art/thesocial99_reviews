import { o as cn, r as SiteShell, t as COMPARISONS } from "./comparisons-4oUkJES9.js";
import { a as RatingStars, i as ReviewCard, n as REVIEW_FAQS, o as CTAButton, r as REVIEWS } from "./faqs-CLF7t3zH.js";
import { _ as PRICING, a as ProsConsBox, g as keywordsForPage, i as TableOfContents, m as buildHead, o as AuthorByline, p as absoluteUrl, r as mergedFaqsForPage, s as breadcrumbJsonLd, t as faqPageJsonLd } from "./faqSchema-C_Qcepuv.js";
import { t as Breadcrumb } from "./breadcrumb-ML1wJytH.js";
import { n as FAQAccordion, r as QuickAnswerBox, t as CTABanner } from "./cta-banner-BGPKr5tk.js";
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: tiers.map((t) => /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					className: "mt-6",
					children: /* @__PURE__ */ jsxs(CTAButton, {
...
//#endregion
//#region src/components/review-page.tsx
...
function ReviewPageView() {
	return /* @__PURE__ */ jsx(SiteShell, { children: /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsx(Breadcrumb, { items: [{
			label: "Home",
			to: "/"
		}, { label: "The Social 99 Review" }] }), /* @__PURE__ */ jsxs("div", {
			className: "mt-8 grid gap-12 lg:grid-cols-[1fr_220px]",
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("header", { children: [
				/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("div", {
					className: "mt-5",
					children: /* @__PURE__ */ jsx(AuthorByline, {
				...
				children: [
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							className: "mt-6",
							children: /* @__PURE__ */ jsx(QuickAnswerBox, {
								title: "Quick summary",
					...
					/* @__PURE__ */ jsxs("section", {
						id: "pros-cons",
						children: [/* @__PURE__ */ jsx("h2", { children: "Pros & Cons of The Social 99" }), /* @__PURE__ */ jsxs("div", {
							className: "grid gap-4 md:grid-cols-2",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2 text-sm font-[650] text-success",
									children: [/* @__PURE__ */ jsx(CheckCircle2, { size: 18 }), " Pros"]
								}), /* @__PURE__ */ jsxs("ul", {
									className: "mt-3 space-y-2 text-sm text-ink",
									children: [
										/* @__PURE__ */ jsx("li", { children: "Fully done-for-you social media management." }),
										/* @__PURE__ */ jsx("li", { children: "Transparent monthly pricing with no setup fee." }),
										/* @__PURE__ */ jsx("li", { children: "Human-created content tailored to your brand." }),
										/* @__PURE__ */ jsx("li", { children: "Review and approval before content is published." }),
										/* @__PURE__ */ jsx("li", { children: "Optional short-form video and website support." })
									]
								})]
							}), /* @__PURE__ */ jsxs("div", {
								className: "rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]",
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(XCircle, { size: 18 }), " Honest limitations"]
								}), /* @__PURE__ */ jsxs("ul", {
									className: "mt-3 space-y-2 text-sm text-muted-foreground",
									children: [
										/* @__PURE__ */ jsx("li", { children: "Best suited for businesses that want a team-managed service rather than a self-serve scheduling tool." }),
										/* @__PURE__ */ jsx("li", { children: "Short-form video content is included only on Growth and Premium plans." }),
										/* @__PURE__ */ jsx("li", { children: "Designed primarily for small and local businesses, not enterprise organizations with complex approval workflows." })
									]
								})]
							})]
						})]
					...
					/* @__PURE__ */ jsxs("section", {
						id: "what-you-get",
						children: [
							/* @__PURE__ */ jsx("h2", { children: "What's Included with The Social 99" }),
							/* @__PURE__ */ jsx("p", { children: "Every The Social 99 plan includes content planning, copywriting, graphic design, scheduling, publishing, and ongoing support. Optional short-form video and website services are available on select plans." }),
							/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("section", {
						id: "pricing",
						children: [
							/* @__PURE__ */ jsx("h2", { children: "The Social 99 Pricing & Plans" }),
							/* @__PURE__ */ jsx("p", { children: "The Social 99 offers three flexible monthly plans starting at $99/month. Every plan includes human-created content, no setup fees, no long-term contracts, and month-to-month billing." }),
							/* @__PURE__ */ jsx("div", {
								className: "not-prose",
					...
					/* @__PURE__ */ jsxs("section", {
						id: "scored",
						children: [/* @__PURE__ */ jsx("h2", { children: "Scored sections" }), /* @__PURE__ */ jsx("div", {
							className: "space-y-4",
							children: scored.map((s) => /* @__PURE__ */ jsxs("div", {
								className: "rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)]",
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("h3", {
										...
										}), /* @__PURE__ */ jsx(RatingStars, { rating: s.score })]
									})]
								}), /* @__PURE__ */ jsx("p", {
									className: "mt-2 text-sm text-muted-foreground",
									children: s.answer
					...
					/* @__PURE__ */ jsxs("section", {
						id: "who-should",
						children: [/* @__PURE__ */ jsx("h2", { children: "Who should use it - and who should skip it" }), /* @__PURE__ */ jsxs("div", {
							className: "grid gap-4 md:grid-cols-2",
							children: [/* @__PURE__ */ jsx(ProsConsBox, {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("table", {
									...
									}) }), /* @__PURE__ */ jsx("tbody", { children: COMPARISONS.map((c, i) => /* @__PURE__ */ jsxs("tr", {
					...
					/* @__PURE__ */ jsxs("section", {
						id: "faqs",
						children: [/* @__PURE__ */ jsx("h2", { children: "Frequently asked questions" }), /* @__PURE__ */ jsx(FAQAccordion, {
							faqs: REVIEW_FAQS,
							idPrefix: "review"
						})]
					}),
					/* @__PURE__ */ jsx("div", {
						className: "not-prose",
						children: /* @__PURE__ */ jsx(CTABanner, {
							pageSlug: SLUG,
			...
			})] }), /* @__PURE__ */ jsx("aside", { children: /* @__PURE__ */ jsx(TableOfContents, { items: TOC }) })]
		})]
	}) });
}
function reviewHead() {
