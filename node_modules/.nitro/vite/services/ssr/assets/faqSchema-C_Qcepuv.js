import { i as SITE, o as cn, t as COMPARISONS } from "./comparisons-4oUkJES9.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Check, X } from "lucide-react";
//#region src/data/pricing.ts
var PRICING = [
	{
		name: "Starter",
		price: 99,
...
//#endregion
//#region src/data/seo/seoKeywords.ts
var SEO_KEYWORDS = [
	{
		n: 1,
...
//#endregion
//#region src/data/seo/metadata.ts
/**
...
//#endregion
//#region src/data/seo/structuredData.ts
...
//#endregion
//#region src/components/author-byline.tsx
function fmt(date) {
	try {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("time", {
					...
					children: ["Last updated ", /* @__PURE__ */ jsx("span", {
						className: "text-ink font-[600]",
						children: fmt(lastUpdated)
					})]
				})
			]
		}), methodology && /* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/components/pros-cons-box.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("h3", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
				...
				className: "mt-2 space-y-2",
				children: cons.map((c) => /* @__PURE__ */ jsxs("li", {
...
//#endregion
//#region src/data/seo/faqSchema.ts
...
//#endregion
export { PRICING as _, ProsConsBox as a, comparisonItemListJsonLd as c, webSiteJsonLd as d, BASE_URL as f, keywordsForPage as g, keywordsForCompetitor as h, TableOfContents as i, organizationJsonLd as l, buildHead as m, mergedFaqsForCompetitor as n, AuthorByline as o, absoluteUrl as p, mergedFaqsForPage as r, breadcrumbJsonLd as s, faqPageJsonLd as t, serviceJsonLd as u };
