import { i as SITE, r as SiteShell, t as COMPARISONS } from "./comparisons-CqVo6bT9.js";
import { i as ReviewCard, o as CTAButton, r as REVIEWS, t as HOME_FAQS } from "./faqs-oXhytwI0.js";
import { n as FAQAccordion, r as QuickAnswerBox, t as CTABanner } from "./cta-banner-n8tDD5H1.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, BadgeDollarSign, CalendarCheck, Hand, Layers, LifeBuoy, Server, ShieldCheck, Sparkles, Target, TrendingUp, Users } from "lucide-react";
...
function Hero({ pageSlug }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 top-0 -z-10 h-64 bg-[radial-gradient(60%_60%_at_50%_0%,var(--tint)_0%,transparent_70%)]" }), /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/moat-card.tsx
...
//#endregion
//#region src/components/niche-strip.tsx
function NicheStrip() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: NICHES.map((n) => /* @__PURE__ */ jsxs("li", {
...
function Home() {
	...
	return /* @__PURE__ */ jsxs(SiteShell, { children: [
		/* @__PURE__ */ jsx(Hero, { pageSlug: "home" }),
		/* @__PURE__ */ jsx("section", {
			className: "container-page mt-4 md:mt-6",
			children: /* @__PURE__ */ jsxs(QuickAnswerBox, { children: [/* @__PURE__ */ jsx("strong", { children: "The direct answer:" }), " The Social 99 is a done-for-you social media service where a human team plans, creates, and publishes your content weekly - from $99/mo, no setup fee, no contract. It's the cheapest way to fully outsource social media without dropping to freelancer-level reliability. This site is operated by The Social 99 and shows only real, consented client reviews."] })
		}),
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							className: "grid h-9 w-9 place-items-center rounded-xl bg-tint text-primary",
							children: /* @__PURE__ */ jsx(TrendingUp, { size: 18 })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "font-[650]",
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: MOATS.map((m) => /* @__PURE__ */ jsx(MoatCard, { moat: m }, m.title))
			})]
		}),
		/* @__PURE__ */ jsx("section", {
			className: "container-page mt-20",
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Read the full comparison ", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
						}), /* @__PURE__ */ jsx(Link, {
							to: "/blog",
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					className: "inline-flex items-center gap-1.5 rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90",
					children: ["Read the review ", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
				})]
			})
		}),
		/* @__PURE__ */ jsxs("section", {
		...
		/* @__PURE__ */ jsx("section", {
			className: "container-page mt-20",
			children: /* @__PURE__ */ jsx(NicheStrip, {})
		}),
		/* @__PURE__ */ jsxs("section", {
			className: "container-page mt-20",
			children: [/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsx("section", {
			className: "container-page mt-20",
			children: /* @__PURE__ */ jsx(CTABanner, { pageSlug: "home" })
		}),
		/* @__PURE__ */ jsx("div", {
