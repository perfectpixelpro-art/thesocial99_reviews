import { o as cn } from "./comparisons-4oUkJES9.js";
import * as React from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, ChevronDown } from "lucide-react";
import * as AccordionPrimitive from "@radix-ui/react-accordion";
//#region src/components/quick-answer-box.tsx
...
//#endregion
//#region src/components/cta-banner.tsx
function CTABanner({ pageSlug, headline = "Ready to hand off your social media?", sub = "Start a free trial or book a 15-minute call. No setup fee, no contract, cancel anytime." }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 h-64 w-64 rounded-full bg-white/5 blur-2xl" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
				...
				children: /* @__PURE__ */ jsxs("a", {
					...
					children: ["Start free trial ", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
				})
			})]
		})]
	});
